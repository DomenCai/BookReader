...
import com.domencai.bookreader.bean.BookListDetail;
import com.domencai.bookreader.bean.BookListTags;
import com.domencai.bookreader.bean.BookLists;
import com.domencai.bookreader.bean.BookMixAToc;
import com.domencai.bookreader.bean.BookRecommend;
import com.domencai.bookreader.bean.BooksByCats;
import com.domencai.bookreader.bean.CategoryList;
import com.domencai.bookreader.bean.CategoryListLv2;
import com.domencai.bookreader.bean.ChapterRead;
import com.domencai.bookreader.bean.HotWord;
import com.domencai.bookreader.bean.RankingList;
import com.domencai.bookreader.bean.Rankings;
import com.domencai.bookreader.bean.Recommend;
import com.domencai.bookreader.bean.RecommendBookList;
import com.domencai.bookreader.bean.SearchDetail;
...
public interface BookApi {
    ...
    Observable<BookLists> getBookLists(@Query("duration") String duration, @Query("sort") String
            sort, @Query("start") String start, @Query("limit") String limit, @Query("tag")
            String tag, @Query("gender") String gender);
