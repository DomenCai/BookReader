package com.domencai.bookreader.activity;
...
import com.domencai.bookreader.R;
import com.domencai.bookreader.api.BookServer;
import com.domencai.bookreader.bean.ChapterBean;
import com.domencai.bookreader.common.BaseAdapter;
import com.domencai.bookreader.common.BaseViewHolder;
import com.domencai.bookreader.common.ItemClickSupport;
import com.domencai.bookreader.common.ItemClickSupport.OnItemClickListener;
...
import com.domencai.bookreader.utils.ScreenUtils;
import com.domencai.bookreader.widget.BookLayout;
import com.domencai.bookreader.widget.BookLayout.OnClickCallback;
...
//    private static final String KEY_BOOK_NAME = "BOOK_NAME";
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus && !mShowTitle) {
            mTitleLayout.setTranslationY(-DrawUtils.dp2px(80));
    ...
    private void showTitle() {
        ...
        mTitleLayout.setTranslationY(0);
        mTitleLayout.setPivotY(0);
        mTitleLayout.setScaleY(0);
        mTitleLayout.animate().scaleY(1).translationY(0).start();
//        mTitleLayout.animate().translationY(0).start();
    ...
    private boolean hideTitle() {
        if (mShowTitle) {
            mBookLayout.setSystemUiVisibility(View.INVISIBLE);
            mTitleLayout.animate().translationY(-DrawUtils.dp2px(80)).start();
            mShowTitle = false;
            return true;
        }
        return false;
